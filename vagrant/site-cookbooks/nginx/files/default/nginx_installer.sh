...
wget -N http://nginx.org/download/nginx-1.0.1.tar.gz
tar xzf nginx-1.0.1.tar.gz
wget -N --no-check-certificate https://github.com/gnosek/nginx-upstream-fair/tarball/master
mv master nginx-upstream-fair.tgz
tar -xvzf nginx-upstream-fair.tgz
wget -N http://www.grid.net.ru/nginx/download/nginx_upload_module-2.2.0.tar.gz
...
--with-ipv6 \
--add-module=../gnosek-nginx-upstream-fair-5f6a3b7 \
